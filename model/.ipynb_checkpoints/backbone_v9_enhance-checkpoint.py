#4个gated conv 从node4_1->node1_3 略过node4_2并且从50epoch开始想你连边缘+CSMA  在每个convgated内部加入注意力机制
#第一次：attention
#第二次：spatial
#第三次：CBMA
...
class MultiNet_v9_enhance(nn.Module):
    def __init__(self,in_channels,block=ReducedResNetBlock):
        super(MultiNet_v9_enhance,self).__init__()
