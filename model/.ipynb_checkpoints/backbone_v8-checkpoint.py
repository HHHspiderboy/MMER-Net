#v4+减少gated resnet的contour+TFDEdgeblock
...
class MultiNet_v8(nn.Module):
    def __init__(self,in_channels,block=ResNetBlock):
        super(MultiNet_v8,self).__init__()
        ...
        self.gatedRes_1=TFDEdgeBlock(param_channels[0],param_channels[3])#encoder->edge
        
        self.gatedRes_2=TFDEdgeBlock(param_channels[3],param_channels[2])
        
        self.gatedRes_3=TFDEdgeBlock(param_channels[2],param_channels[1])
    ...
    def forward(self,x,tag):
        ...
        edge_out=self.gatedRes_1(edge_out,self.up_8(out3_3))
        edge_out=self.gatedRes_2(edge_out,self.up_4(out2_3))
        edge_out=self.gatedRes_3(edge_out,self.up_2(out1_3))
